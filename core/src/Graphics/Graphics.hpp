...
namespace IWXMVM::GFX
{
    ...
    class GraphicsManager
    {
       public:
        ...
        std::optional<int32_t> GetSelectedNodeId() const
        {
            return selectedNodeId;
        }
        bool WasObjectHoveredThisFrame() const
        {
            return objectHoveredThisFrame;
        }
        bool WasObjectDraggedThisFrame() const
        {
            return heldAxis.has_value();
        }
